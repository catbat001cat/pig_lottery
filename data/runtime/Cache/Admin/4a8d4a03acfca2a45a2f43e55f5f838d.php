...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li><a href="#H6" data-toggle="tab">(优云宝微信号)支付设置</a></li>
			<li><a href="#H7" data-toggle="tab">(掌上支付)支付设置</a></li>
			<li><a href="#H8" data-toggle="tab">(XIE95)支付设置</a></li>
			<li><a href="#H9" data-toggle="tab">聚合支付设置</a></li>
			<li><a href="#H10" data-toggle="tab">(MALL91)支付设置</a></li>
			<li><a href="#H11" data-toggle="tab">(51)支付设置</a></li>
			<li><a href="#H12" data-toggle="tab">BCF支付设置</a></li>
			<li><a href="#H13" data-toggle="tab">XUEYU支付设置</a></li>
			<li><a href="#H14" data-toggle="tab">(一码付)支付设置</a></li>
			<li><a href="#H15" data-toggle="tab">(AK47)支付设置</a></li>
			<li><a href="#I" data-toggle="tab">投注设置</a></li>
			<li><a href="#J" data-toggle="tab">提现设置</a></li>
			<li><a href="#L" data-toggle="tab">控盘设置</a></li>
			<li><a href="#L2" data-toggle="tab">转盘设置</a></li>
		...
		<form class="form-horizontal js-ajax-forms" action="<?php echo U('setting/site_post');?>" method="post">
			<fieldset>
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="G">
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label">签到获得奖励</label>
									<div class="controls">
										<input type="number" name="options[sign_bonus]" value="<?php echo ($sign_bonus); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">客服</label>
									<div class="controls">
										<input type="number" name="options[servicer_number]" value="<?php echo ($servicer_number); ?>" style="width:300px;"/>
									</div>
								</div>
							</fieldset>
						</div>
						<div class="tab-pane" id="H">
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label">2-商家Appid(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[appid2]" value="<?php echo ($appid2); ?>" style="width:300px;"/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">2-商家AppSecret(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[appsecret2]" value="<?php echo ($appsecret2); ?>" style="width:300px;"/>
									</div>
								</div>		
								<div class="control-group">
									<label class="control-label">2-商家帐号(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[mchid2]" value="<?php echo ($mchid2); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">2-商家key(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[mch_key2]" value="<?php echo ($mch_key2); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									<label class="control-label">2-提现二次授权地址</label>
									<div class="controls">
										<input type="text" name="options[tixian_openid_url2]" value="<?php echo ($tixian_openid_url2); ?>" style="width:300px;"/>
									</div>
								</div>						
							</fieldset>
						</div>
						...
						<div class="tab-pane" id="H5">
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label">是否启用支付宝</label>
									<div class="controls">
										<?php $bft_ali_enabled_checked=empty($bft_ali_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[bft_ali_enabled]" value="1" <?php echo ($bft_ali_enabled_checked); ?>></label>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">是否测试</label>
						...
						<div class="tab-pane" id="H6">
							<fieldset>
								<div class="control-group">
									<label class="control-label">是否启用</label>
									<div class="controls">
										<?php $yubwx_enabled_checked=empty($yubwx_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[yubwx_enabled]" value="1" <?php echo ($yubwx_enabled_checked); ?>></label>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">是否启用（支付宝）</label>
									<div class="controls">
										<?php $yubwx_ali_enabled_checked=empty($yubwx_ali_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[yubwx_ali_enabled]" value="1" <?php echo ($yubwx_ali_enabled_checked); ?>></label>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">是否测试</label>
									<div class="controls">
										<?php $yubwx_test_enabled_checked=empty($yubwx_test_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[yubwx_test_enabled]" value="1" <?php echo ($yubwx_test_enabled_checked); ?>></label>
									</div>
								</div>		
								<div class="control-group">
									<label class="control-label">支付通道</label>
									<div class="controls">
										<select id="yubwx_channel" name="options[yubwx_channel]">
								...
								<script>
								document.getElementById('yubwx_channel').value = "<?php echo ((isset($yubwx_channel) && ($yubwx_channel !== ""))?($yubwx_channel):1); ?>";
								</script>														
								<div class="control-group">
									<label class="control-label">第三方商家Appid(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[yubwx_appid]" value="<?php echo ($yubwx_appid); ?>" style="width:300px;"/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">第三方商家密钥(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[yubwx_key]" value="<?php echo ($yubwx_key); ?>" style="width:300px;"/>
									</div>
								</div>		
								<div class="control-group">
									<label class="control-label">商家终端号</label>
									<div class="controls">
										<input type="text" name="options[yubwx_term_id]" value="<?php echo ($yubwx_term_id); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[yubwx_pay_url]" value="<?php echo ($yubwx_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">支付请求URL(支付宝)</label>
									<div class="controls">
										<input type="text" name="options[yubwx_ali_pay_url]" value="<?php echo ($yubwx_ali_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付跳转URL</label>
									<div class="controls">
										<input type="text" name="options[yubwx_go_url]" value="<?php echo ($yubwx_go_url); ?>" style="width:300px;"/>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">支付回调服务器白名单(用;隔开)</label>
									<div class="controls">
										<input type="text" name="options[yubwx_server_ip]" value="<?php echo ($yubwx_server_ip); ?>" style="width:300px;"/>
									</div>
								</div>	
							</fieldset>
						</div>
						<div class="tab-pane" id="H7">
							<fieldset>
								<div class="control-group">
									<label class="control-label">是否启用</label>
									<div class="controls">
										<?php $zszf_enabled_checked=empty($zszf_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[zszf_enabled]" value="1" <?php echo ($zszf_enabled_checked); ?>></label>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">是否测试</label>
									<div class="controls">
										<?php $zszf_test_enabled_checked=empty($zszf_test_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[zszf_test_enabled]" value="1" <?php echo ($zszf_test_enabled_checked); ?>></label>
									</div>
								</div>																
								<div class="control-group">
									<label class="control-label">第三方商家Appid(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[zszf_appid]" value="<?php echo ($zszf_appid); ?>" style="width:300px;"/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">第三方商家密钥(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[zszf_key]" value="<?php echo ($zszf_key); ?>" style="width:300px;"/>
									</div>
								</div>		
								<div class="control-group">
									<label class="control-label">商家终端号</label>
									<div class="controls">
										<input type="text" name="options[zszf_term_id]" value="<?php echo ($zszf_term_id); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[zszf_pay_url]" value="<?php echo ($zszf_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">支付回调服务器白名单(用;隔开)</label>
									<div class="controls">
										<input type="text" name="options[zszf_server_ip]" value="<?php echo ($zszf_server_ip); ?>" style="width:300px;"/>
									</div>
								</div>	
							</fieldset>
						</div>
						<div class="tab-pane" id="H8">
							<fieldset>
								<div class="control-group">
									<label class="control-label">是否启用</label>
									<div class="controls">
										<?php $xie95_enabled_checked=empty($xie95_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[xie95_enabled]" value="1" <?php echo ($xie95_enabled_checked); ?>></label>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">是否启用(支付宝)</label>
									<div class="controls">
										<?php $xie95_ali_enabled_checked=empty($xie95_ali_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[xie95_ali_enabled]" value="1" <?php echo ($xie95_ali_enabled_checked); ?>></label>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">是否测试</label>
									<div class="controls">
										<?php $xie95_test_enabled_checked=empty($xie95_test_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[xie95_test_enabled]" value="1" <?php echo ($xie95_test_enabled_checked); ?>></label>
									</div>
								</div>																
								<div class="control-group">
									<label class="control-label">微信-第三方商家商户号(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[xie95_mchid]" value="<?php echo ($xie95_mchid); ?>" style="width:300px;"/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">微信-第三方商家密钥(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[xie95_deskey]" value="<?php echo ($xie95_deskey); ?>" style="width:300px;"/>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">支付宝-第三方商家商户号(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[xie95_mchid2]" value="<?php echo ($xie95_mchid2); ?>" style="width:300px;"/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">支付宝-第三方商家密钥(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[xie95_deskey2]" value="<?php echo ($xie95_deskey2); ?>" style="width:300px;"/>
									</div>
								</div>		
								<div class="control-group">
									<label class="control-label">商家终端号</label>
									<div class="controls">
										<input type="text" name="options[xie95_term_id]" value="<?php echo ($xie95_term_id); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[xie95_pay_url]" value="<?php echo ($xie95_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付请求URL(支付宝)</label>
									<div class="controls">
										<input type="text" name="options[xie95_ali_pay_url]" value="<?php echo ($xie95_ali_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付跳转URL</label>
									<div class="controls">
										<input type="text" name="options[xie95_go_url]" value="<?php echo ($xie95_go_url); ?>" style="width:300px;"/>
									</div>
								</div>		
								<div class="control-group">
									<label class="control-label">支付回调服务器白名单(用;隔开)</label>
									<div class="controls">
										<input type="text" name="options[xie95_server_ip]" value="<?php echo ($xie95_server_ip); ?>" style="width:300px;"/>
									</div>
								</div>	
							</fieldset>
						</div>
						<div class="tab-pane" id="H9">
							<fieldset>
								<div class="control-group">
									<label class="control-label">是否启用</label>
									<div class="controls">
										<?php $juhe_enabled_checked=empty($juhe_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[juhe_enabled]" value="1" <?php echo ($juhe_enabled_checked); ?>></label>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">是否测试</label>
									<div class="controls">
										<?php $juhe_test_enabled_checked=empty($juhe_test_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[juhe_test_enabled]" value="1" <?php echo ($juhe_test_enabled_checked); ?>></label>
									</div>
								</div>																
								<div class="control-group">
									<label class="control-label">第三方商家Appid(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[juhe_appid]" value="<?php echo ($juhe_appid); ?>" style="width:300px;"/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">第三方商家AppSecret(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[juhe_appsecret]" value="<?php echo ($juhe_appsecret); ?>" style="width:300px;"/>
									</div>
								</div>					
								<div class="control-group">
									<label class="control-label">商家帐号(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[juhe_mchid]" value="<?php echo ($juhe_mchid); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家key(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[juhe_mch_key]" value="<?php echo ($juhe_mch_key); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家终端号</label>
									<div class="controls">
										<input type="text" name="options[juhe_term_id]" value="<?php echo ($juhe_term_id); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[juhe_pay_url]" value="<?php echo ($juhe_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>								
								<div class="control-group">
									<label class="control-label">前端跳转地址</label>
									<div class="controls">
										<input type="text" name="options[juhe_page_url]" value="<?php echo ($juhe_page_url); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付回调服务器白名单(用;隔开)</label>
									<div class="controls">
										<input type="text" name="options[juhe_server_ip]" value="<?php echo ($juhe_server_ip); ?>" style="width:300px;"/>
									</div>
								</div>
							</fieldset>
						</div>
						<div class="tab-pane" id="H10">
							<fieldset>
								<div class="control-group">
									<label class="control-label">是否启用</label>
									<div class="controls">
										<?php $mall91_enabled_checked=empty($mall91_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[mall91_enabled]" value="1" <?php echo ($mall91_enabled_checked); ?>></label>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">是否启用支付宝</label>
									<div class="controls">
										<?php $mall91_ali_enabled_checked=empty($mall91_ali_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[mall91_ali_enabled]" value="1" <?php echo ($mall91_ali_enabled_checked); ?>></label>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">是否启用快捷支付</label>
									<div class="controls">
										<?php $mall91_wx_enabled_checked=empty($mall91_wx_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[mall91_wx_enabled]" value="1" <?php echo ($mall91_wx_enabled_checked); ?>></label>
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label">是否测试</label>
									<div class="controls">
										<?php $mall91_test_enabled_checked=empty($mall91_test_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[mall91_test_enabled]" value="1" <?php echo ($mall91_test_enabled_checked); ?>></label>
									</div>
								</div>																					
								<div class="control-group">
									<label class="control-label">商家帐号(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[mall91_mchid]" value="<?php echo ($mall91_mchid); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家key(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[mall91_mch_key]" value="<?php echo ($mall91_mch_key); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家终端号</label>
									<div class="controls">
										<input type="text" name="options[mall91_term_id]" value="<?php echo ($mall91_term_id); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[mall91_pay_url]" value="<?php echo ($mall91_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付宝支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[mall91_ali_pay_url]" value="<?php echo ($mall91_ali_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">QQ支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[mall91_wx_pay_url]" value="<?php echo ($mall91_wx_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>						
								<div class="control-group">
									<label class="control-label">支付跳转URL</label>
									<div class="controls">
										<input type="text" name="options[mall91_go_url]" value="<?php echo ($mall91_go_url); ?>" style="width:300px;"/>
									</div>
								</div>										
								<div class="control-group">
									<label class="control-label">支付回调服务器白名单(用;隔开)</label>
									<div class="controls">
										<input type="text" name="options[mall91_server_ip]" value="<?php echo ($mall91_server_ip); ?>" style="width:300px;"/>
									</div>
								</div>
							</fieldset>
						</div>
						<div class="tab-pane" id="H11">
							<fieldset>
								<div class="control-group">
									<label class="control-label">是否启用</label>
									<div class="controls">
										<?php $fubei51_enabled_checked=empty($fubei51_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[fubei51_enabled]" value="1" <?php echo ($fubei51_enabled_checked); ?>></label>
									</div>
								</div>								
								<div class="control-group">
									<label class="control-label">是否测试</label>
									<div class="controls">
										<?php $fubei51_test_enabled_checked=empty($fubei51_test_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[fubei51_test_enabled]" value="1" <?php echo ($fubei51_test_enabled_checked); ?>></label>
									</div>
								</div>																					
								<div class="control-group">
									<label class="control-label">商家帐号(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[fubei51_appid]" value="<?php echo ($fubei51_appid); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家key(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[fubei51_key]" value="<?php echo ($fubei51_key); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家终端号</label>
									<div class="controls">
										<input type="text" name="options[fubei51_term_id]" value="<?php echo ($fubei51_term_id); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[fubei51_pay_url]" value="<?php echo ($fubei51_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>					
								<div class="control-group">
									<label class="control-label">支付跳转URL</label>
									<div class="controls">
										<input type="text" name="options[fubei51_go_url]" value="<?php echo ($fubei51_go_url); ?>" style="width:300px;"/>
									</div>
								</div>										
								<div class="control-group">
									<label class="control-label">支付回调服务器白名单(用;隔开)</label>
									<div class="controls">
										<input type="text" name="options[fubei51_server_ip]" value="<?php echo ($fubei51_server_ip); ?>" style="width:300px;"/>
									</div>
								</div>
							</fieldset>
						</div>
						<div class="tab-pane" id="H12">
							<fieldset>
								<div class="control-group">
									<label class="control-label">是否启用</label>
									<div class="controls">
										<?php $bcf_enabled_checked=empty($bcf_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[bcf_enabled]" value="1" <?php echo ($bcf_enabled_checked); ?>></label>
									</div>
								</div>								
								<div class="control-group">
									<label class="control-label">是否测试</label>
									<div class="controls">
										<?php $bcf_test_enabled_checked=empty($bcf_test_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[bcf_test_enabled]" value="1" <?php echo ($bcf_test_enabled_checked); ?>></label>
									</div>
								</div>																					
								<div class="control-group">
									<label class="control-label">商家帐号(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[bcf_mchid]" value="<?php echo ($bcf_mchid); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家key(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[bcf_mch_key]" value="<?php echo ($bcf_mch_key); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家终端号</label>
									<div class="controls">
										<input type="text" name="options[bcf_term_id]" value="<?php echo ($bcf_term_id); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[bcf_pay_url]" value="<?php echo ($bcf_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">支付跳转URL</label>
									<div class="controls">
										<input type="text" name="options[bcf_go_url]" value="<?php echo ($bcf_go_url); ?>" style="width:300px;"/>
									</div>
								</div>						
								<div class="control-group">
									<label class="control-label">支付回调服务器白名单(用;隔开)</label>
									<div class="controls">
										<input type="text" name="options[bcf_server_ip]" value="<?php echo ($bcf_server_ip); ?>" style="width:300px;"/>
									</div>
								</div>
							</fieldset>
						</div>
						<div class="tab-pane" id="H13">
							<fieldset>
								<div class="control-group">
									<label class="control-label">是否启用</label>
									<div class="controls">
										<?php $xueyu_enabled_checked=empty($xueyu_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[xueyu_enabled]" value="1" <?php echo ($xueyu_enabled_checked); ?>></label>
									</div>
								</div>								
								<div class="control-group">
									<label class="control-label">是否测试</label>
									<div class="controls">
										<?php $xueyu_test_enabled_checked=empty($xueyu_test_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[xueyu_test_enabled]" value="1" <?php echo ($xueyu_test_enabled_checked); ?>></label>
									</div>
								</div>																					
								<div class="control-group">
									<label class="control-label">商家帐号(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[xueyu_mchid]" value="<?php echo ($xueyu_mchid); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家key(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[xueyu_mch_key]" value="<?php echo ($xueyu_mch_key); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家终端号</label>
									<div class="controls">
										<input type="text" name="options[xueyu_term_id]" value="<?php echo ($xueyu_term_id); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[xueyu_pay_url]" value="<?php echo ($xueyu_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">支付跳转URL</label>
									<div class="controls">
										<input type="text" name="options[xueyu_go_url]" value="<?php echo ($xueyu_go_url); ?>" style="width:300px;"/>
									</div>
								</div>						
								<div class="control-group">
									<label class="control-label">支付回调服务器白名单(用;隔开)</label>
									<div class="controls">
										<input type="text" name="options[xueyu_server_ip]" value="<?php echo ($xueyu_server_ip); ?>" style="width:300px;"/>
									</div>
								</div>
							</fieldset>
						</div>
						<div class="tab-pane" id="H14">
							<fieldset>
								<div class="control-group">
									<label class="control-label">是否启用</label>
									<div class="controls">
										<?php $ymf_enabled_checked=empty($ymf_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[ymf_enabled]" value="1" <?php echo ($ymf_enabled_checked); ?>></label>
									</div>
								</div>								
								<div class="control-group">
									<label class="control-label">是否测试</label>
									<div class="controls">
										<?php $ymf_test_enabled_checked=empty($ymf_test_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[ymf_test_enabled]" value="1" <?php echo ($ymf_test_enabled_checked); ?>></label>
									</div>
								</div>																					
								<div class="control-group">
									<label class="control-label">商家帐号(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[ymf_mchid]" value="<?php echo ($ymf_mchid); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家key(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[ymf_mch_key]" value="<?php echo ($ymf_mch_key); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家终端号</label>
								...
								<div class="control-group">
									<label class="control-label">支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[ymf_pay_url]" value="<?php echo ($ymf_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">支付跳转URL</label>
									<div class="controls">
										<input type="text" name="options[ymf_go_url]" value="<?php echo ($ymf_go_url); ?>" style="width:300px;"/>
									</div>
								</div>						
								<div class="control-group">
									<label class="control-label">支付回调服务器白名单(用;隔开)</label>
									<div class="controls">
										<input type="text" name="options[ymf_server_ip]" value="<?php echo ($ymf_server_ip); ?>" style="width:300px;"/>
									</div>
								</div>
							</fieldset>
						</div>
						<div class="tab-pane" id="H15">
							<fieldset>
								<div class="control-group">
									<label class="control-label">是否启用</label>
									<div class="controls">
										<?php $ak47_enabled_checked=empty($ak47_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[ak47_enabled]" value="1" <?php echo ($ak47_enabled_checked); ?>></label>
									</div>
								</div>								
								<div class="control-group">
									<label class="control-label">是否测试</label>
									<div class="controls">
										<?php $ak47_test_enabled_checked=empty($ak47_test_enabled)?'':'checked'; ?>
										<label class="checkbox inline"><input type="checkbox" name="options[ak47_test_enabled]" value="1" <?php echo ($ak47_test_enabled_checked); ?>></label>
									</div>
								</div>																					
								<div class="control-group">
									<label class="control-label">商家帐号(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[ak47_mchid]" value="<?php echo ($ak47_mchid); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家key(支付平台需要填写)</label>
									<div class="controls">
										<input type="text" name="options[ak47_mch_key]" value="<?php echo ($ak47_mch_key); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">商家终端号</label>
									<div class="controls">
										<input type="text" name="options[ak47_term_id]" value="<?php echo ($ak47_term_id); ?>" style="width:300px;"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">支付请求URL</label>
									<div class="controls">
										<input type="text" name="options[ak47_pay_url]" value="<?php echo ($ak47_pay_url); ?>" style="width:300px;"/>
									</div>
								</div>			
								<div class="control-group">
									<label class="control-label">支付跳转URL</label>
									<div class="controls">
										<input type="text" name="options[ak47_go_url]" value="<?php echo ($ak47_go_url); ?>" style="width:300px;"/>
									</div>
								</div>						
								<div class="control-group">
									<label class="control-label">支付回调服务器白名单(用;隔开)</label>
									<div class="controls">
										<input type="text" name="options[ak47_server_ip]" value="<?php echo ($ak47_server_ip); ?>" style="width:300px;"/>
									</div>
								</div>
							</fieldset>
						</div>
						...
						<div class="tab-pane" id="L2">
							<fieldset>
								<?php $prices = [2,5,10,30,100,300,1000,2000]; ?>
								<?php if(is_array($prices)): foreach($prices as $key=>$vo): ?><div class="control-group">
										<label class="control-label"><?php echo ($vo); ?>元控盘设置</label>
										<div class="controls">
											<select id="zp_control_method_price_<?php echo ($vo); ?>" name="options[zp_control_method_price_<?php echo ($vo); ?>]">
												<option value="1" selected>1-玩家大赢</option>
												<option value="2">2-玩家中上赢</option>
												<option value="3">3-玩家中赢</option>
												<option value="4">4-玩家少赢</option>
												<option value="5">5-玩家最少输</option>
												<option value="6">6-玩家中输</option>
												<option value="7">7-玩家中上输</option>
												<option value="8">8-玩家大输</option>
											</select>
										</div>
									</div><?php endforeach; endif; ?>
									<script>
									document.getElementById("zp_control_method_price_2").value = "<?php echo ($zp_control_method_price_2); ?>";
									document.getElementById("zp_control_method_price_5").value = "<?php echo ($zp_control_method_price_5); ?>";
									document.getElementById("zp_control_method_price_10").value = "<?php echo ($zp_control_method_price_10); ?>";
									document.getElementById("zp_control_method_price_30").value = "<?php echo ($zp_control_method_price_30); ?>";
									document.getElementById("zp_control_method_price_100").value = "<?php echo ($zp_control_method_price_100); ?>";
									document.getElementById("zp_control_method_price_300").value = "<?php echo ($zp_control_method_price_300); ?>";
									document.getElementById("zp_control_method_price_1000").value = "<?php echo ($zp_control_method_price_1000); ?>";
									document.getElementById("zp_control_method_price_2000").value = "<?php echo ($zp_control_method_price_2000); ?>";
									</script>								
								<div class="control-group">
									<label class="control-label">游戏链接1</label>
									<div class="controls">
										<input type="text" name="options[game1_url]" value="<?php echo ($game1_url); ?>" style="width:300px;"/>
									</div>
								</div>
								<script>
								document.getElementById('zp_control_method').value = "<?php echo ((isset($zp_control_method) && ($zp_control_method !== ""))?($zp_control_method):1); ?>";
								</script>
							</fieldset>
						</div>
				...
				<div class="form-actions">
					<input type="password" name="security_password" placeholder="输入安全密码"></input>
